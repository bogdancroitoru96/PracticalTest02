...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            pageTextView.setText(Constants.EMPTY_STRING);

            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), city, pageTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPageButton = (Button)findViewById(R.id.get_page_forecast_button);
        getPageButton.setOnClickListener(getWeatherForecastButtonClickListener);
        pageTextView = (TextView)findViewById(R.id.weather_forecast_text_view);
    }
